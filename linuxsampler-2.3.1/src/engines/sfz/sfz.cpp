...
namespace sfz
{
    ...
    Instrument::Instrument(File* file, std::string name, SampleManager* pSampleManager) : KeyBindings(128, false), KeySwitchBindings(128, false)
    {
        this->file = file;
        this->name = name;
    ...
    File::File(std::string file, SampleManager* pSampleManager) :
        ...
        note_offset(0)
    {
        _instrument = new Instrument(this, LinuxSampler::Path::getBaseName(file), pSampleManager);
